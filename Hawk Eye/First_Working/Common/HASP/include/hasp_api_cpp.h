...
//
//
// $Id: hasp_api_cpp.h,v 1.8 2010-06-08 02:57:18 pwang Exp $
////////////////////////////////////////////////////////////////////
...
public:
	...
	static haspStatus detach(const std::string& action, const std::string& scope, hasp_vendor_code_t vendorCode, 
							 const std::string& recipient, std::string& v2c);
	static haspStatus detach(const char* pszAction, const char* pszScope, hasp_vendor_code_t vendorCode, 
