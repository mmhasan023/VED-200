...
public:
	...
	void TestFunc       ( );
	void DCTCodeBlock   ( );
	void DetectEdgeBlock( );
	void DetectStripe   ( );
	void DetectBlockiness   ( );
...
protected:
	...
	afx_msg void OnCximageTest();
	afx_msg void OnUpdateCximageTest(CCmdUI* pCmdUI);

	afx_msg void OnCximageCornerDetection();
	afx_msg void OnUpdateCximageCornerDetection(CCmdUI* pCmdUI);


	float	GetAvg					( DWORD dwSum																		);
	void	GetBlockData			( LPBYTE lpBytePixelBlock, BYTE **lpOutBlockByte, BYTE **lpRightData,BYTE **lpBottomData, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	void	GetBlockData			( LPBYTE lpBytePixelBlock, LPBYTE *lpLine1, LPBYTE *lpLine2, LPBYTE *lpLine3, LPBYTE *lpLine4, LPBYTE *lpLine5, LPBYTE *lpLine6, LPBYTE *lpLine7, LPBYTE *lpLine8, BYTE **lpRightData,BYTE **lpBottomData, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	DWORD	GetSum					( BYTE** lpBytePixelBlock, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth		);
	DWORD	GetSum					( LPBYTE lpBytePixelBlock, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth)		;
	DWORD	GetSum					( LPBYTE lpLine1, LPBYTE lpLine2, LPBYTE lpLine3, LPBYTE lpLine4, LPBYTE lpLine5, LPBYTE lpLine6, LPBYTE lpLine7, LPBYTE lpLine8, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float	GetAbsolute				( float nInput																		);
	float   GetVariance				( DWORD dwAvg, BYTE** lpBytePixelBlock, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float   GetVariance				( DWORD dwAvg, LPBYTE lpBytePixelBlock, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float   GetVariance				( DWORD dwAvg, LPBYTE lpLine1, LPBYTE lpLine2, LPBYTE lpLine3, LPBYTE lpLine4, LPBYTE lpLine5, LPBYTE lpLine6, LPBYTE lpLine7, LPBYTE lpLine8, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float   GetRightBoundaryPixel	( DWORD dwVar, BYTE** lpBytePixelBlock, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float	GetRightBoundaryPixel	( DWORD dwVar, LPBYTE lpBytePixelBlock,  LPBYTE lpRightData, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float   GetRightBoundaryPixel	( DWORD dwVar, LPBYTE lpLine1, LPBYTE lpLine2, LPBYTE lpLine3, LPBYTE lpLine4, LPBYTE lpLine5, LPBYTE lpLine6, LPBYTE lpLine7, LPBYTE lpLine8, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float   GetBottomBoundaryPixel	( DWORD dwVar, BYTE** lpBytePixelBlock, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	//float   GetBottomBoundaryPixel  ( DWORD dwVar, LPBYTE lpBytePixelBlock,  LPBYTE lpBottomData, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	float   GetBottomBoundaryPixel  (DWORD dwVar, LPBYTE lpLine8, LPBYTE lpBottomData, unsigned int nHeightPoint, unsigned int nWidthPoint, unsigned int nHeight, unsigned int nWidth);
	HRESULT CheckBlockiness			( BYTE* lpBytePixelBlock, DWORD dwBufferSize, UINT nHeight, UINT nWidth, UINT nHeightPoint, UINT nWidthPoint, UINT nBlockType	);
	void	DetectBlockiness		( const LPBYTE lpData, const int& nWidth, const int& nHeight, LPVECTOR_LINE lpvecotrLine );

	afx_msg void OnCximageDetectBlock();
	afx_msg void OnUpdateCximageDetectBlock(CCmdUI* pCmdUI);

	afx_msg void OnCximageDetectDCTCodeBlock();//ID_CXIMAGE_DETECTDCTCODEBLOCK
	afx_msg void OnUpdateCximageDetectDCTCodeBlock(CCmdUI* pCmdUI);

	afx_msg void OnCximageDetectEdgeBlock();
	afx_msg void OnUpdateCximageDetectEdgeBlock(CCmdUI* pCmdUI);

	afx_msg void OnCximageDetectStripe();//ID_CXIMAGE_DTTECTSTRIPE
	afx_msg void OnUpdateCximageDetectStripe(CCmdUI* pCmdUI);

	afx_msg void OnCximageDetectBlockiness();//ID_CXIMAGE_DTTECTSTRIPE
	afx_msg void OnUpdateCximageDetectBlockiness(CCmdUI* pCmdUI);
